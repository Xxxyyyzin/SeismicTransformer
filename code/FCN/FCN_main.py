...
from FCN_constants import Constants
import losses
...
class Trainer:
    ...
    def train(self):
        ...
        with open(c.MODEL_OUT_DIR + "testing_%s_%s_%s_%.8i.txt" % (c.MODEL_NAME, c.LOSS_NAME, c.OPTIMIZER, i + 1),
                  'w') as f:
...
if __name__ == "__main__":
    ...
    cs = [Constants(RUN="fault_AutoEncoder_Adam_l1_mean_loss_gain",
