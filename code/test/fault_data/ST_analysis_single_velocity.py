...
d = load_testdataset_SeisTrans("fault_2ms_r_generalisation.bin",rootdir="./", N_EXAMPLES=30, c_dict=c_dict100thous, verbose=False)   #N_EXAMPLES 表示数据集下有多少个数据
...
print("Trans:")
print(value_trans)
plt.savefig("./fault_Seismictransformer_l1.pdf")